...
(async () => {
    ...
    let playerName = playerNameAnswer.playerName;
    while (running) {
        ...
        let currentEnemy = enemySelection.selectedEnemy;
        // Generate random health for the current enemy
        let currentEnemyHealth = getRandomNumber(50, enemyHealth);
        // Log the encounter
        ...
        while (currentEnemyHealth > 0 && ourHealth > 0) {
            ...
            switch (control.action) {
                case "Attack":
                    let attackDamage = getRandomNumber(10, ourAttack);
                    let enemyDamage = getRandomNumber(5, enemyAttack);
                    ...
                    if (currentEnemyHealth > 0) {
                        ...
                        let potionDropChance = getRandomNumber(1, 100);
